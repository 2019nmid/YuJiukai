...
<script language="javascript" type="text/javascript" src="js/redirectPhoneUrl.js"></script>
...
<body>
	...
	<div id="login_body">
		...
		<div class="zw">
			...
			<div class="cont-a">
				<a href="javascript:void(0);" onclick="return redirectUrl('0110');" class="a1"><img src="images/icon_pretend.png" alt=""></a>
